# Дано массив целых чисел, вернуть все тойнички [a,b,c] для которых a+b+c=0. Рушение не должно содержать дубликаты, такие как [1,2,3] и [2,3,1]. Если ничего не найдено вернуть []
# Тройники можно вернуть влюбом порядке и аорядке содержимого.
# Пример
